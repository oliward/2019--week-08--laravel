...
\img{10cm}{02/img/api-01}{1em}{A web app talks to the API using HTTP requests}
\img{10cm}{02/img/api-02}{1em}{A completely separate iOS app can use the same API}
\img{10cm}{02/img/api-03}{1em}{And an Android app can use the same API too}
...
\img{14cm}{02/img/postman}{0em}{Postman}
